    ...
    if len(all_vehicles) > 1:
        ...
        for distance_of_car,vehicle in sorted_vehicles : #complete this code
            if distance_of_car>200.0 : #complete this code
                break
            vehicle_type = get_actor_display_name(vehicle)#complete this code
            vehicle_data['vehicle_name'] = vehicle_type#complete this code
            vehicle_data['distance'] = distance_of_car#complete this code
            ...
            for distance_in_meter in final_vehicle_result: #complete this code
                if distance_in_meter["disatnce"]>6 and distance_in_meter["distance"]<10 : #complete this code
                    dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.2)) #complete this code
                    time.sleep(3)#complete this code
                    dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.2,steer = -0.2))#complete this code
